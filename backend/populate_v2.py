...
def populate_v2():
    """Populate the industry_benchmarks_v2 table"""
    ...
    try:
        print("Populating industry_benchmarks_v2 table...")
        ...
        conn.commit()
        print(f"Successfully populated industry_benchmarks_v2 table with {len(default_benchmarks)} benchmark records")
